...
describe("SVG", () => {
  ...
  it("should append text element", () => {
    ...
    const svg = new SVG("A", "white", new Square("blue"));
    expect(svg.render()).toEqual(expectedSvg);
  });
  ...
  it("should set text message and color", () => {
    ...
    const svg = new SVG("SVG", "#333", new Square("blue"));
    expect(svg.render()).toEqual(expectedSvg);
  });
  ...
  it("should throw if text exceeds 3 characters", () => {
    ...
    expect(() => new SVG("Hello", "white", new Square("blue"))).toThrow(
      expectedError
    );
  });
  ...
  it("should include a shape", () => {
    ...
    const svg = new SVG("SVG", "#333", new Square("dodgerblue"));
    expect(svg.render()).toEqual(expectedSvg);
  });
});
